...
\ifpdf  
    \pdfinfo { /Title  (Semantically-enabled Browsing of Large Multilingual Document Collections)
               ...
               /CreationDate (D:202010000000)  %format D:YYYYMMDDhhmmss
               /ModDate (D:202105171352)
               /Subject (artificial intelligence)
               /Keywords (document similarity, topic models, large scale comparisons, semantic annotation) }
...
\include{intro/intro}	
\include{soa/soa}	
\include{hypothesis/hypothesis}
\include{scalability/scalability}
\include{explainability/explainability}
\include{comparisons/comparisons}
\include{multilinguality/multilinguality}
