...
The main contributions in this dimension are described in section\ref{ch:explainability}as follows:
\begin{itemize}
...
The main contributions in this dimension are described in section \ref{ch:comparisons} as follows:
\begin{itemize}
