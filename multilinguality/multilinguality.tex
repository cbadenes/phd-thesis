...
\begin{table*}\centering
 ...
 \textbf{\textit{"communications systems"}} & \textbf{\textit{"sistema de comunicaci\'on"}} & \textbf{\textit{"systeme de communication"}} & \textbf{\textit{"meios de comunicação"}} & \textbf{\textit{"strutture di comunicazione"}} \\ 
