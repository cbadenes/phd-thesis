...
\end{tabular}
 ...
 \vspace*{3mm}
 \caption{MAP results by dividing the corpus into \\ nine equal subsets to train and evaluate the models}
 \label{table:acquis9}
\end{table}
