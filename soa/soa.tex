...
The second area is \textbf{topic explainability}, which refers to the capacity of topics to capture and describe the content of a text. Topic explainability is important for simplifying the text representations and make understandable the relationships that are derived.
...
All four areas are closely related to each other. Having a clear thematic representation of a text, distance metrics that measure intersections between its themes, and strategies that abstract the particularities of a language to represent the themes, may help to efficiently organize large multilingual document collections.
...
A summary of the research areas and their limitations can be found in Table~\ref{table:limitations}.
